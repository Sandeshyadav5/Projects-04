...
/**
 * UserCtl is a Controller class responsible for handling
 * User operations such as Add, Update, Validation, and View.
 * 
 * It interacts with UserModel and RoleModel to perform
...
public class UserCtl extends BaseCtl {
	...
	/**
	 * Validates user input fields for User form.
	 * 
	 * @param request HttpServletRequest object
	...
	/**
	 * Handles GET request.
	 * Loads User data by ID (if present) and forwards to view.
	 * 
	 * @param request  HttpServletRequest object
