...
/**
 * Model class for performing CRUD operations on College.
 * Provides methods for add, update, delete, search, and retrieval of college records.
 */
public class CollegeModel {

    /**
     * Gets next primary key from database.
     * 
    ...
    /**
     * Adds a new College record into database.
     * 
    ...
    public long add(CollegeBean bean) throws ApplicationException, DuplicateRecordException {
        Connection conn=null;
        int pk=0;
        CollegeBean existName=findByName(bean.getName());
        if(existName!=null) {
     ...
     * 
     * @param bean CollegeBean containing ID of record to delete
    ...
    /**
     * Searches College records based on criteria with pagination.
     * 
