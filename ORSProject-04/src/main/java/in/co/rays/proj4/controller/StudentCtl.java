...
/**
 * StudentCtl is a Controller class responsible for handling
 * Student operations such as Add, Update, Validation, and View.
 * 
 * It interacts with StudentModel and CollegeModel to perform
 * database operations and preload required data.
 * 
...
public class StudentCtl extends BaseCtl {
	...
	/**
	 * Preloads required data such as College List.
	 * 
	...
	/**
	 * Validates user input fields for Student form.
	 * 
	 * @param request HttpServletRequest object
	...
	/**
	 * Handles GET request.
	 * Loads Student data by ID (if present) and forwards to view.
	 * 
	 * @param request  HttpServletRequest object
