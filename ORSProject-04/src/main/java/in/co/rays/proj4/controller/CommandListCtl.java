...
@WebServlet(name = "CommandListCtl", urlPatterns = { "/ctl/CommandListCtl" })
public class CommandListCtl extends BaseCtl {
        ...
        try {
            ...
            if (OP_SEARCH.equalsIgnoreCase(op)
                ...
                if (ids != null && ids.length > 0) {
                    ...
                    CommandBean deleteBean = new CommandBean();
    ...
    protected String getView() {
        return ORSView.COMMAND_LIST_VIEW;
    }
}