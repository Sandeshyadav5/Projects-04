...
@WebServlet(name = "EmojiListCtl", urlPatterns = { "/ctl/EmojiListCtl" })
public class EmojiListCtl extends BaseCtl {
        ...
        try {
            ...
            if (OP_SEARCH.equalsIgnoreCase(op)
                ...
                if (ids != null && ids.length > 0) {
                    ...
                    EmojiBean deleteBean = new EmojiBean();
    ...
    protected String getView() {
        return ORSView.EMOJI_LIST_VIEW;
    }
}