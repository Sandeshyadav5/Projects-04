...
/**
 * FacultyCtl handles operations related to Faculty.
 * It manages validation, data population, add, update,
 * and dropdown preload (College, Course, Subject).
 * 
...
public class FacultyCtl extends BaseCtl {
    ...
    /**
     * Preloads dropdown data such as College, Course, and Subject.
     * 
     ...
     * Loads faculty data for editing if ID is provided.
     * 
     * @param request  HttpServletRequest
    ...
    /**
     * Returns the view page for Faculty
     * 
     * @return view path
     */
    @Override
