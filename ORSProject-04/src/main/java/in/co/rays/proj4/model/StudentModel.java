...
/**
 * Model class for performing CRUD operations on Student table.
 * Handles database interaction for StudentBean.
 */
public class StudentModel {
    ...
    public long add(StudentBean bean) throws ApplicationException, DuplicateRecordException {
        ...
        if (existEmail != null) {
            throw new DuplicateRecordException("Student email already exist");
        }
    ...
    public StudentBean findByEmail(String email) throws ApplicationException {
        ...
        try {
            ...
            throw new ApplicationException("Excception :Exception in getting student by Email");
        } finally {
            JDBCDataSource.closeConnection(conn);
        }
        return bean;
    ...
    /**
     * Searches student records with filters and pagination.
     */
