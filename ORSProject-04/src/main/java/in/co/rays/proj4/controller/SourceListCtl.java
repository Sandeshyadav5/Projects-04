...
@WebServlet(name = "SourceListCtl", urlPatterns = { "/ctl/SourceListCtl" })
public class SourceListCtl extends BaseCtl {
        ...
        try {
            ...
            if (OP_SEARCH.equalsIgnoreCase(op)
                ...
                if (ids != null && ids.length > 0) {
                    ...
                    SourceBean deleteBean = new SourceBean();
    ...
    protected String getView() {
        return ORSView.SOURCE_LIST_VIEW;
    }
}