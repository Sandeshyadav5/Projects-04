...
@WebServlet(name = "GenderListCtl", urlPatterns = { "/ctl/GenderListCtl" })
public class GenderListCtl extends BaseCtl {
        ...
        try {
            ...
            if (OP_SEARCH.equalsIgnoreCase(op)
                ...
                if (ids != null && ids.length > 0) {
                    ...
                    GenderBean deleteBean = new GenderBean();
    ...
    protected String getView() {
        return ORSView.GENDER_LIST_VIEW;
    }
}