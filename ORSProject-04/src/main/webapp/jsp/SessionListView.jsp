...
<body>
	...
	<div align="center">
		...
		<h1 align="center" style="margin-bottom: -15; color: navy;">Session
			List</h1>
		...
		<form action="<%=ORSView.SESSION_LIST_CTL%>" method="POST">
			...
			<table style="width: 100%">
				<tr>
					<td align="center"><label><b>Session Code : </b></label> <%=HTMLUtility.getList("sessionCode", String.valueOf(bean.getSessionCode()), nameList)%> <input type="submit"
			...
			<table border="1" style="width: 100%; border: groove;">
				...
				<tr>
					...
					<td align="center"><%=bean.getSessionCode()%></td>
					<td align="center"><%=bean.getUserName()%></td>
					<td align="center"><%=bean.getLoginTime()%></td>
					<td align="center"><%=bean.getStatus()%></td>

					<td align="center"><a href="SessionCtl?id=<%=bean.getId()%>">Edit</a>
					</td>
				</tr>
